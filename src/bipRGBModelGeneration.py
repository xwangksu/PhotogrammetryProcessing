...
compr.tiff_compression = Metashape.ImageCompression.TiffCompressionJPEG
# compr.tiff_big = False
# compr.tiff_overviews = False
# compr.tiff_tiled = False

chunk.exportRaster(path=dem, image_format=Metashape.ImageFormatJPEG, projection=proj, nodata_value=-9999, save_kml=False, save_world=False, image_compression=compr, white_background=False, source_data=Metashape.ElevationData)

chunk.exportRaster(path=orthomosaic, image_format=Metashape.ImageFormatJPEG, projection=proj, save_kml=False, save_world=False, image_compression=compr, white_background=False, source_data=Metashape.OrthomosaicData)
